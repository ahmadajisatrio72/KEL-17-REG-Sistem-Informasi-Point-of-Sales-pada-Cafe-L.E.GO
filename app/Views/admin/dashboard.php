...
<head>
    ...
    <style>
        ...
        .btn-logout { 
            background: var(--button-gradient); border: none; color: white; 
            border-radius: 10px; width: 100%; padding: 10px; margin-top: 15px;
            font-weight: 600; box-shadow: 0 4px 15px rgba(108, 76, 255, 0.3);
        }
...
<div class="sidebar d-flex flex-column" id="sidebar">
    <div class="d-flex align-items-center mb-5 ps-1">
        ...
        <div>
            ...
            <small style="opacity: 0.6; font-size: 10px; text-transform: uppercase;"><?= $role ?></small>
        </div>
    </div>

    <nav class="nav flex-column mb-auto">
        <a class="nav-link active" href="#"><i class="bi bi-grid-1x2"></i> Dashboard</a>
        <a class="nav-link" href="#"><i class="bi bi-cup-hot"></i> Kelola Menu</a>
        <a class="nav-link" href="#"><i class="bi bi-list-task"></i> Kategori</a>
        <a class="nav-link" href="#"><i class="bi bi-clock-history"></i> Histori Transaksi</a>
        <a class="nav-link" href="#"><i class="bi bi-bar-chart-line"></i> Laporan Keuangan</a>
        <a class="nav-link" href="#"><i class="bi bi-people"></i> Kelola User</a>
    </nav>
...
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-none d-lg-block"></div> <div class="d-flex gap-3 text-muted">
    ...
    <div class="mb-5">
        <h1 class="fw-bold h2" style="color: #0f0c29;">Dashboard</h1>
        <p class="text-muted small">Ringkasan bisnis hari ini</p>
    </div>
