...
/**
 * @var float $omzet
 * @var int $jmlTransaksi
 * @var int $totalProduk
 * @var int $stokMenipisCount
...
<head>
    ...
    <title><?= $title ?? 'Dashboard Admin - Caffe Lego' ?></title>
...
<div class="main-content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5 bg-white p-3 rounded-4 shadow-sm">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h1 class="fw-bold h3 mb-0" style="color: #0f0c29;">Dashboard Admin</h1>
    ...
    <div class="row g-4 mb-2">
        ...
        <div class="col-6">
            <div class="card-stat">
                <div class="date-small">Update</div>
        ...
        <div class="col-6">
            <div class="card-stat">
                <div class="date-small">Peringatan</div>
                <div class="label-gray">Menu Habis</div>
                <div class="val-dark text-danger"><?= $stokMenipisCount ?> <small class="fs-6 fw-normal">Menu</small></div>
